...
CREATE DATABASE `gsb_frais` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `gsb_frais`;
...
CREATE TABLE `fichefrais` (
  ...
  KEY `idEtat` (`idEtat`),
  CONSTRAINT `fichefrais_ibfk_1` FOREIGN KEY (`idVisiteur`) REFERENCES `visiteur` (`id`),
  CONSTRAINT `fichefrais_ibfk_2` FOREIGN KEY (`idEtat`) REFERENCES `Etat` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `fichefrais` (`id`, `idVisiteur`, `mois`, `annee`, `nbJustificatifs`, `montantValide`, `dateModif`, `idEtat`) VALUES
(1,	'1',	12,	2021,	NULL,	564.96,	'2022-03-24',	'CL'),
...
CREATE TABLE `lignefraisforfait` (
  ...
  CONSTRAINT `lignefraisforfait_ibfk_2` FOREIGN KEY (`idForfait`) REFERENCES `Forfait` (`id`),
  CONSTRAINT `lignefraisforfait_ibfk_3` FOREIGN KEY (`idFicheFrais`) REFERENCES `fichefrais` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
